...
var curDate = (date.getMonth() + 1) + '/' + date.getDate() + '/' +  date.getFullYear();
 $( function() {
  ...
  $('#appointmentTime').timepicker({
   ...
   $(window).click(function(){
       var aptTime = $('#appointmentTime').val();
       var aptDate = $('#datepicker').val();
       var date = new Date(aptDate);
       var aptYear = date.getFullYear();
       var aptMonth = date.getMonth();
       var aptDay = date.getDate();
   ...
   $('#datepicker').click(function(){
       ...
       var aptDay = date.getDate();
       var fullAptDate = (aptYear + '-' + (aptMonth + 1) + '-' + aptDay);
       if (fullAptDate === 'NaN-NaN-NaN') {
           $('#datepicker').css('background', '#fcc');
           $('.hs_submit input').attr( "disabled", 'disabled' );
           $('#datepicker').addClass('wasClicked');
       } else {
            $('#datepicker').css('background', '#fff');
            $('.hs_submit input').attr( "disabled", false );
       }
   });
   $(window).click(function(){
       var aptDate = $('#datepicker').val();
       ...
       var aptDay = date.getDate();
       var fullAptDate = (aptYear + '-' + (aptMonth + 1) + '-' + aptDay);
       if($('#datepicker').hasClass('wasClicked')) {
           if (fullAptDate === 'NaN-NaN-NaN') {
           $('#datepicker').css('background', '#fcc');
           $('.hs_submit input').attr( "disabled", 'disabled' );
           $('#datepicker').addClass('wasClicked');
   ...
   $(window).click(function(){
       ...
       if ((pickedDate === curDate) && (date1 < date2)) {
           ...
           $('.hs_submit input').attr( "disabled", 'disabled' );
            ...
            $('.ui-timepicker-input').css('background', '#fff');
            $('.hs_submit input').attr( "disabled", false );
       }
   });
 });
